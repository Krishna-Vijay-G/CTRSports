...
import { MAX_FAMILY_LINKS, type Family } from "./model";
...
import { LINK_GLYPHS } from "@/lib/sections/shared/icons";
import type { SectionPanelProps } from "@/lib/sections/types";


export function FamilyPanel({ value, onChange }: SectionPanelProps<Family>) {
